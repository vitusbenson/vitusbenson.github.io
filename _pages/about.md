...
I train deep neural networks on data of the Earth system. More specifically, I am focusing on two applications. On the one hand, I am interested in the applicability of large-scale AI to Early Warning Systems. Within the [EarthNet initiative](https://www.earthnet.tech) we are leveraging high resolution satellite imagery to build data-driven impact early warning systems -- with applications to anticipatory action for droughts and heat waves. Beyond my own work, I am collaborating within the [RiskKAN Working Group _AI for Complex Climate Risk Mitigation_](https://www.risk-kan.org/about-riskkan/working-groups/ai-for-complex-climate-risk-mitigation/), which I happen to co-chair aswell.
On the other hand, as part of the [AI4Carbon Community Initiative](https://ai4carbon.github.io/) I explore the use of deep neural networks for carbon cycle research. In particular, I am assessing the use of representation learning for atmospheric transport and inverse modeling -- analogous to how recent works have revolutionized numerical weather prediction and other areas of scientific machine learning.
